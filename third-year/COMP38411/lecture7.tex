...
\flashcard{\normalfont
  A \blank{\textbf{digital certificate}} is a statement which certifies that this public key belongs to this identity, and that the owner with this identity possesses the corresponding private key.
}
...
\card{\normalfont
  ...
  \begin{flushleft}
    ...
    - A CA or CA hierarchy digitally signs keys in a top-down manner.
  \end{flushleft}
  PKI Trust Models
}
